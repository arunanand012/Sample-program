...
//        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(sAddToCart))).click();
    ...
    public static WebElement getElement(final By locator) {
        ...
        FluentWait<WebDriver> webDriverFluentWait = wait.withTimeout(30, SECONDS);
        FluentWait<WebDriver> webDriverFluentWait1 = wait.pollingEvery(5, SECONDS);
        FluentWait<WebDriver> ignoring = wait.ignoring(NoSuchElementException.class);
